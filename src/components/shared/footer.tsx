    ...
    <footer className="bg-[#191C1F]">
      <div className="md:w-[70%] w-[85%] mx-auto">
        <div className=" items-start grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 xl:grid-cols-5 justify-between gap-10 md:py-18 py-10">
          <section className="space-y-4 text-background dark:text-white">
            ...
            <div>
              <p className="text-xs font-medium leading-5 text-background/50 dark:text-white/50">
                Customer Supports:
              </p>
            ...
            <p className="text-xs font-medium text-background/50 dark:text-white/50">
              4517 Washington Ave.
              <br />
          ...
          <section className="text-background dark:text-white">
                  ...
                  <span
                    className={cn(
                      ...
                      item === "Accessories"
                        ...
                        : "text-background/50 dark:text-white/50",
                    )}
                  >
                    {item}
                  </span>
          ...
          <section className="text-background dark:text-white pr-8">
            <h3 className="mb-6 text-sm uppercase text-nowrap">Quick Links</h3>
            <ul className="space-y-4 text-xs text-background/50 dark:text-white/50">
              {links.map((item) => (
        ...
        <div className="border-t border-[#30373d] py-4 text-center">
          <p className="text-xs font-medium text-background/60 dark:text-white/60">
