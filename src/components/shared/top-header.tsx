      ...
      <div className="flex flex-wrap items-center justify-center gap-2.5">
        ...
        <div className="flex flex-wrap items-center justify-center md:gap-2.5 gap-1.5">
          <svg
            ...
            className="md:size-3.5 size-3 shrink-0 cursor-pointer"
          >
            <path
          ...
          <svg
            ...
            xmlns="http://www.w3.org/2000/svg"
          >
            <g clipPath="url(#topHeadingFacebookClip)">
              <path
                fillRule="evenodd"
                clipRule="evenodd"
            ...
            <defs>
              <clipPath id="topHeadingFacebookClip">
          ...
          <svg
            ...
            xmlns="http://www.w3.org/2000/svg"
          >
            <g clipPath="url(#topHeadingPinterestClip)">
              <path
            ...
            <defs>
              <clipPath id="topHeadingPinterestClip">
                <path fill="#fff" d="M0 0h16v16H0z" />
              </clipPath>
            </defs>
          </svg>
          ...
          <svg
            ...
            xmlns="http://www.w3.org/2000/svg"
          >
            <g clipPath="url(#topHeadingRedditClip)">
            ...
            <defs>
              <clipPath id="topHeadingRedditClip">
                <path fill="#fff" d="M0 0h16v16H0z" />
              </clipPath>
            </defs>
          </svg>
          ...
          <svg
            ...
            xmlns="http://www.w3.org/2000/svg"
          >
            <g clipPath="url(#topHeadingInstagramClip)">
              <path
            ...
            <defs>
              <clipPath id="topHeadingInstagramClip">
                <path fill="#fff" d="M0 0h16v16H0z" />
              </clipPath>
            </defs>
          </svg>
